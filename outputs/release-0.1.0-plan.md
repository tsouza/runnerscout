...
| Full Helm chart | Schema/render/config tests; real install, helm test, upgrade, rollback, uninstall and retained-state checks; RBAC, Secret and workload-identity configurations | Ten render/package/config tests and real idle PAT-mode lifecycle passed; App/packaged/architecture coverage and release acceptance pending |
