...
| Local harness | Formatting, vet, build and all 25 current race tests passed, including Azure. Eight completion-manifest integrity controls passed. CI verifies the exact PR revision; see PR #6. |
